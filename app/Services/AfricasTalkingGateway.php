...
class AfricasTalkingGateway {
    ...
    // Payments
    public function bankPaymentCheckoutCharge($productName_, $bankAccount_, $currencyCode_, $amount_, $narration_, $metadata_) {
    ...
    public function bankPaymentCheckoutValidation($transactionId_, $otp_) {
        $this->_requestBody = json_encode(array("username" => $this->_username,
    ...
    public function bankPaymentTransfer($productName_, $recipients_) {
        $this->_requestBody = json_encode(array("username" => $this->_username,
            "productName" => $productName_,
    ...
    public function cardPaymentCheckoutCharge($productName_, $paymentCard_, $currencyCode_, $amount_, $narration_, $metadata_) {
    ...
    public function cardPaymentCheckoutChargeWithToken($productName_, $checkoutToken_, $currencyCode_, $amount_, $narration_, $metadata_) {
        $this->_requestBody = json_encode(array("username" => $this->_username,
            "productName" => $productName_,
            "checkoutToken" => $checkoutToken_,
            "currencyCode" => $currencyCode_,
    ...
    public function cardPaymentCheckoutValidation($transactionId_, $otp_) {
        $this->_requestBody = json_encode(array("username" => $this->_username,
            "transactionId" => $transactionId_,
            "otp" => $otp_));
    ...
    public function initiateMobilePaymentCheckout($productName_, $phoneNumber_, $currencyCode_, $amount_, $metadata_) {
        $this->_requestBody = json_encode(array("username" => $this->_username,
            "productName" => $productName_,
            "phoneNumber" => $phoneNumber_,
            "currencyCode" => $currencyCode_,
    ...
    public function mobilePaymentB2CRequest($productName_, $recipients_) {
        $this->_requestBody = json_encode(array("username" => $this->_username,
            "productName" => $productName_,
            "recipients" => $recipients_));
